...
public class AttendanceFileOperator {
	...
	public void readFile() throws IOException, ParseException {
		String excelFilePath = "attendanceNewMin.xls";
		...
		while (rowIterator.hasNext()) {
			...
			if (!OperationHelper.isRowEmpty(nextRow)) { 	// ignore empty rows.
					...
					while (cellIterator.hasNext()) {
						...
						if (cell.getColumnIndex() >= inOutStartColumnNumber	&& cell.getColumnIndex() <= inOutEndColumnNumber) {
							...
							if(cell.getCellType()== Cell.CELL_TYPE_STRING){
								inOutList.add(CalenderService.convertToTime(formatter.formatCellValue(cell)));
							}
							else{
				...
				else if(nextRow.getCell(nextRow.getFirstCellNum()).getStringCellValue().equals("")){
